...
<script>
	function addCart(){
		...
		location.href = "${pageContext.request.contextPath}/addCart?pid=${product.pid}&buyNum="+buyNum;
	}
</script>
<style>
.left{
	...
	<div id = "body" style = "background-color:rgb(252, 213, 213);">
		...
		<div class = "right">
			...
			<div style="width: 100%; margin:20px 0;">
				<div>上市时间：<fmt:formatDate
							 value="${product.pdate }" /></div>
			...
			<a style = "margin-top:120px;display:block;color:#adadad;font-size:13px;" href = "${pageContext.request.contextPath}/productByCategory?cid=${product.cid }">返回列表页面</a>
		</div>
	</div>
