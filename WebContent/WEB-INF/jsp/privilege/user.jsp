	...
	<div id="body">
		<div class="menu">
			<ul class="function_list">
				...
				<li><a href = "${pageContext.request.contextPath}/cart.html">购物车</a></li>
				<li><a
					href="${pageContext.request.contextPath}/user/userOrders"
					target="main_frame">我的订单</a></li>
				<li><a
					href="${pageContext.request.contextPath}/user/balance"
					target="main_frame">我的余额</a></li>
				<li><a href="${pageContext.request.contextPath}/user/address"
					target="main_frame">地址管理</a></li>
			</ul>
		</div>
		<div class="content">
			<iframe name="main_frame" id="main_frame"
				src="${pageContext.request.contextPath}/user/userInfo"
