...
<script type="text/javascript">
	...
	function modify(pid) {
		$
				.ajax({
					url : "${pageContext.request.contextPath}/admin/showProductInfo",
					data : {
						"pid" : pid
					},
					async : true,
	...
	function submitModify() {
		$
				.ajax({
					url : "${pageContext.request.contextPath}/admin/modifyProduct",
	...
	function orderBy() {
		...
		$.ajax({
			url : "${pageContext.request.contextPath}/admin/orderBy",
			data : {
				"cid" : cateValue,
				"price" : price,
				"amount" : amount
...
<body>
	<div style="display: inline-block; width: 100%; height: 80px;">
		...
		<select name="price" onchange="selectprice()">
			<option value="">默认</option>
			<option value="asc">升序</option>
			<option value="desc">降序</option>
		</select>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <span style="color: #adadad">库存：</span>
		<select name="amount" onchange="selectamount()">
			<option value="">默认</option>
			<option value="asc">升序</option>
			<option value="desc">降序</option>
		</select>
