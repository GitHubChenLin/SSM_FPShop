...
<body>
	...
	<div style = "margin:0 auto;display:block;text-align:center;">
		<form action = "${pageContext.request.contextPath }/admin/addOrchange" method="post">
			...
			<c:forEach var="category" items="${categoryList}">
				<tr>
					...
					<td><span class="modify" data-aid="${category.cid }" onclick = "modify('${category.cid }','${category.cname}')">修改</span> <span>
							| </span> <span class="del" data-aid="${category.cid }" onclick= "delCategory('${category.cid }')">删除</span></td>
				</tr>
			</c:forEach>
		</table>
	</c:if>
