	...
	<div id="body">
		<div class="menu">
			<ul class="function_list">
				<li class="active"><a
					href="${pageContext.request.contextPath}/admin/category" target="main_frame">分类管理</a></li>
				<li><a href = "${pageContext.request.contextPath}/admin/Product" target="main_frame">商品管理</a></li>
				<li><a
					href="${pageContext.request.contextPath}/admin/orderManage"
					target="main_frame">订单管理</a></li>
				<li><a
					href="${pageContext.request.contextPath}/admin/userManage"
